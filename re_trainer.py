...
import models
import utils
from tacred_utils import constant, scorer
...
class Trainer(object):
    ...
    def __init__(self, args, dataset):
        ...
        self.valid_data = self.dataset['score_dev_batch']
        self.eval_data = self.dataset['eval_dev_batch']
        self.test_data = self.dataset['test_batch']
    ...
    def build_model(self):
        ...
        if self.args.network_type == 'rnn':
            if self.args.dataset == 'tacred':
                self.shared = models.TACRED_RNN(self.args, self.dataset)
            else:
    ...
    def train_controller(self):
        ...
        for step in range(self.args.controller_max_step):
            ...
            valid_idx = (valid_idx + 1) % len(self.valid_data)
